...
public interface UserProvider {
    ...
    /**
     * Retrieves all users whose email contains the given fragment (case-insensitive).
     *
    ...
    /**
     * Retrieves all users born before the given date (i.e. older than a person born on that date).
     *
